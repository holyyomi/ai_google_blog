...
_SYSTEM_PROMPT_EN = (
    ...
    "results. Never invent product names, tool names, GitHub repositories, or URLs — only name a "
    "specific tool or link if it is in the provided evidence; otherwise describe how to find it "
